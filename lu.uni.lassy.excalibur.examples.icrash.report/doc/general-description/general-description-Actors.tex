...
A \msrcode{hospital} is a service responsible to treat a crisis.

The objectives of a \msrcode{hospital} are:
\begin{itemize}
  \item to manage the received crisis
\end{itemize}
\vspace{0.5cm}
In order to achieve these objectives, the responsibilities of a
\msrcode{hospital} are:
\begin{itemize}
...
\begin{itemize}
  ...
  \item \msrcode{actHospital}: for the Hospital stakeholder.
\end{itemize}
