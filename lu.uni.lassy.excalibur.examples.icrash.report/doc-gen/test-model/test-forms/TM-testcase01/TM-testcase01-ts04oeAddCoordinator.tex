	...
	\begin{teststepmodel}
		...
		\begin{description}
			...
			\item[] \textbf{\hyperlink{actAdministrator.outactAdministrator.oeAddCoordinator}{actAdministrator.outactAdministrator.oeAddCoordinator} (AdtAuthenticatedID, AdtLogin, AdtPassword)}
		\end{description}}
		...
		\addnumberedsinglerow{C}{AdtAuthenticatedID is equal to 1 to set the new coordinator ID}
	...
	variables{
		...
		AdtAuthenticatedID : dtAuthenticatedID
		AdtLogin:dtLogin
