...
\addnumberedsinglerow{}{\msrucname{oeSendToHospital [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeSendToHospital} use case}
