...
\addrowheading{Reuse}
\addnumberedsinglerow{}{\msrucname{oeLogin [0..1]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actAuthenticated} executes the \msrucname{ugSMSAuthentification} use case}
