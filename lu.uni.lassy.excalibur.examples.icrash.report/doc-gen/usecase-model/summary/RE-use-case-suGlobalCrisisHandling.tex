...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{ugSMSAuthentification} use case}
...
\addnumberedsinglerow{}{steps (a) (b) (c) and (d) executions are interleaved 
